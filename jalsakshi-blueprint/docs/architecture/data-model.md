...
| actions | tenant_id, id, case_id, description, owner_id, due_at, completed_at, evidence_ids | Completion must be explicitly reviewed where policy requires; index tenant/case_id |
